...
@php
  $next_route = isset($is_livewire) ? 'r4.populations.index_live' : 'r4.populations.index';
@endphp

<div class="d-flex flex-wrap">
  <div class="me-auto">
    @if (Route::has('r4.populations.create'))
      <a href="{{ route('r4.populations.create', $conds) }}" class="btn btn-success mb-2">新規登録</a>
    @endif

    @if (Route::has('r4.populations.seq'))
      <a href="{{ route('r4.populations.seq', $conds) }}" class="btn btn-outline-success ms-2 mb-2">並び順変更</a>
    @endif  
  </div>
  ...
  <div class="ms-auto">
    ...
    @if (Route::has('r4.populations.report'))
      <a href="{{ route('r4.populations.report', $conds) }}" class="btn btn-outline-primary ms-2 mb-2"><i class="bi bi-download"></i> レポート</a>
    @endif

    @if (Route::has('r4.populations.download'))
      {{-- TODO: remove $conds if download all data. --}}
      <a href="{{ route('r4.populations.download', $conds) }}" class="btn btn-outline-primary ms-2 mb-2"><i class="bi bi-download"></i> ダウンロード</a>
    @endif


    @if (Route::has('r4.populations.uploader'))
      <a href="{{ route('r4.populations.uploader') }}" class="btn btn-outline-primary ms-2 mb-2" dusk="upload-button"><i
