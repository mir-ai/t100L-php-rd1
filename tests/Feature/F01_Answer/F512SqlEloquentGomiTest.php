 ...
 * 
 */
class F512SqlEloquentGomiTest extends TestCase
{
    // Gアイロン(name)の連絡ごみ(gomi_type)の処理手数料(fee)を探してみよう
    public function test_512_010_iron_price(): void
    {
        $rows = [];
    ...
    // name 順に、上位 3 件
    public function test_512_020_without_battery(): void
    {
        $rows = [];
    ...
    public function test_512_030_total_prices(): void
    {
        $rows = [];
